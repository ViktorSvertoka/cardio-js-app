...
class Workout {
  ...
  _setDescription() {
    this.type === 'running'
      ? (this.description = `Пробіжка ${new Intl.DateTimeFormat('uk-UA').format(
          this.date
        )}`)
...
class App {
  ...
  _loadMap(position) {
    ...
    // Обробка кліка на карті
    this.#map.on('click', this._showForm.bind(this));

    // Відображення тренувань із local storage на карті
  ...
  _newWorkout(e) {
    ...
    // Додати новий об'єкт до масиву тренувань
    this.#workouts.push(workout);

    // Відобразити тренування на карті
    this._displayWorkout(workout);

    // Відобразити тренування у списку
    this._displayWorkoutOnSidebar(workout);

    // Сховати форму та очистити поля введення даних
    this._hideForm();

    // Додати всі тренування до локального сховища
